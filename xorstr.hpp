...
class xor_string<CharT, Size, std::integer_sequence<std::uint64_t, Keys...>,
  ...
  public:
    ...
    template <class L>
    XORSTR_FORCEINLINE xor_string(L l,
    ...
    XORSTR_FORCEINLINE void crypt() noexcept {
        // everything is inlined by hand because a certain compiler with a
        // certain linker is _very_ slow
    ...
    defined(__arm__)
        ...
        ((Indices >= sizeof(_storage) / 32
              ...
              : _mm256_store_si256(
                    ...
                    _mm256_xor_si256(
                        _mm256_load_si256(
                            reinterpret_cast<const __m256i *>(_storage) +
                            Indices),
                        _mm256_load_si256(
        ...
        ((Indices >= sizeof(_storage) / 16
              ...
              : _mm_store_si128(
                    ...
                    _mm_xor_si128(
                        _mm_load_si128(
                            reinterpret_cast<const __m128i *>(_storage) +
                            Indices),
